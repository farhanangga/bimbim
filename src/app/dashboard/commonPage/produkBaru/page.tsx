  ...
  return (
    <div className="relative min-h-screen text-[#1D172F]">
      ...
      <div className="lg:ml-[260px] p-0 lg:px-4 lg:py-6">
        <div className="bg-white p-4 lg:p-8 rounded-none lg:rounded-2xl shadow-none lg:shadow-lg h-full lg:min-h-165 pb-22">
          ...
          <p className="hidden lg:flex font-semibold text-lg mt-4">Tambah Produk</p>
